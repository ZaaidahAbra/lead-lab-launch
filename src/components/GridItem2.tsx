...
const GridItem2 = () => {
  return (
    <div className="relative bg-primary min-h-[490px] overflow-hidden flex flex-col justify-center -mt-24 md:-mt-12 pt-12 md:pt-8">
      ...
      <div className="relative w-full overflow-hidden py-10 px-6 md:px-12 -mt-10 md:-mt-14">
        <div className="flex animate-marquee whitespace-nowrap">
          {Array.from({ length: 6 }).map((_, i) => (
            <span
              key={i}
              className="py-10 font-display text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mx-8 tracking-wider"
            >
              COMING SOON
            </span>
          ))}
